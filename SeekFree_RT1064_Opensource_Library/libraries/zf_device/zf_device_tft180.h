...
#define TFT180_RES_PIN                  (B2 )                                   // 液晶复位引脚定义
#define TFT180_DC_PIN                   (C19)                                   // 液晶命令位引脚定义
...
#define tft180_displayimage032(p, width, height)        (tft180_show_gray_image(0, 0, (p), MT9V03X_W, MT9V03X_H, (width), (height), 0))
